...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR uint32_t math_read32_little_endian_m685EF3EB1C4DB187A503707B71860BC8239DB65C (void* ___0_pBuffer, const RuntimeMethod* method) 
{
	...
	uint32_t V_1 = 0;
	{
		...
		V_1 = ((int32_t)(((int32_t)(((int32_t)(L_2|((int32_t)(L_4<<8))))|((int32_t)(L_6<<((int32_t)16)))))|((int32_t)(L_8<<((int32_t)24)))));
		goto IL_001f;
	}
...
IL_0042:
	{
		uint8_t* L_8 = V_0;
		uint32_t L_9;
		L_9 = math_read32_little_endian_m685EF3EB1C4DB187A503707B71860BC8239DB65C_inline((void*)L_8, NULL);
		uint8_t* L_10 = V_0;
		uint32_t L_11;
		L_11 = math_read32_little_endian_m685EF3EB1C4DB187A503707B71860BC8239DB65C_inline((void*)((uint8_t*)il2cpp_codegen_add((intptr_t)L_10, 4)), NULL);
		uint8_t* L_12 = V_0;
		uint32_t L_13;
		L_13 = math_read32_little_endian_m685EF3EB1C4DB187A503707B71860BC8239DB65C_inline((void*)((uint8_t*)il2cpp_codegen_add((intptr_t)L_12, 8)), NULL);
		uint8_t* L_14 = V_0;
		uint32_t L_15;
		L_15 = math_read32_little_endian_m685EF3EB1C4DB187A503707B71860BC8239DB65C_inline((void*)((uint8_t*)il2cpp_codegen_add((intptr_t)L_14, ((int32_t)12))), NULL);
		uint4__ctor_m59B6A219A0285C60FCF2977679BF89C72B502008_inline((&V_6), L_9, L_11, L_13, L_15, NULL);
		uint4_t6C69CBFAE9BF0F727D52B68779D4A3F0DBA8D5C9 L_16 = V_3;
		uint4_t6C69CBFAE9BF0F727D52B68779D4A3F0DBA8D5C9 L_17 = V_6;
		uint4_t6C69CBFAE9BF0F727D52B68779D4A3F0DBA8D5C9 L_18;
		L_18 = uint4_op_Multiply_m40354E397B1D99D73B5333378C8698C087A1A2D6_inline(L_17, ((int32_t)-2048144777), NULL);
		uint4_t6C69CBFAE9BF0F727D52B68779D4A3F0DBA8D5C9 L_19;
		L_19 = uint4_op_Addition_m391200EB43B6C4CDD219079A0D3CDFFA35B0B652_inline(L_16, L_18, NULL);
		V_3 = L_19;
		uint4_t6C69CBFAE9BF0F727D52B68779D4A3F0DBA8D5C9 L_20 = V_3;
		uint4_t6C69CBFAE9BF0F727D52B68779D4A3F0DBA8D5C9 L_21;
		L_21 = math_rol_mBB124D060A7DB1CA1F35BBE4FC0AA20BB6B05375_inline(L_20, ((int32_t)13), NULL);
		V_3 = L_21;
		uint4_t6C69CBFAE9BF0F727D52B68779D4A3F0DBA8D5C9 L_22 = V_3;
		uint4_t6C69CBFAE9BF0F727D52B68779D4A3F0DBA8D5C9 L_23;
		L_23 = uint4_op_Multiply_m40354E397B1D99D73B5333378C8698C087A1A2D6_inline(L_22, ((int32_t)-1640531535), NULL);
		V_3 = L_23;
		uint8_t* L_24 = V_0;
		V_0 = ((uint8_t*)il2cpp_codegen_add((intptr_t)L_24, ((int32_t)16)));
		int32_t L_25 = V_5;
...
IL_009d:
	...
	}
	{
		...
		uint32_t L_30 = L_29.___x;
		uint32_t L_31;
		L_31 = math_rol_m70DA2C8F44A27EE0D749AEEDEF8B0CD82D90B93F_inline(L_30, 1, NULL);
		uint4_t6C69CBFAE9BF0F727D52B68779D4A3F0DBA8D5C9 L_32 = V_3;
		uint32_t L_33 = L_32.___y;
		uint32_t L_34;
		L_34 = math_rol_m70DA2C8F44A27EE0D749AEEDEF8B0CD82D90B93F_inline(L_33, 7, NULL);
		uint4_t6C69CBFAE9BF0F727D52B68779D4A3F0DBA8D5C9 L_35 = V_3;
		uint32_t L_36 = L_35.___z;
		uint32_t L_37;
		L_37 = math_rol_m70DA2C8F44A27EE0D749AEEDEF8B0CD82D90B93F_inline(L_36, ((int32_t)12), NULL);
		uint4_t6C69CBFAE9BF0F727D52B68779D4A3F0DBA8D5C9 L_38 = V_3;
		uint32_t L_39 = L_38.___w;
		uint32_t L_40;
		L_40 = math_rol_m70DA2C8F44A27EE0D749AEEDEF8B0CD82D90B93F_inline(L_39, ((int32_t)18), NULL);
		V_1 = ((int32_t)il2cpp_codegen_add(((int32_t)il2cpp_codegen_add(((int32_t)il2cpp_codegen_add((int32_t)L_31, (int32_t)L_34)), (int32_t)L_37)), (int32_t)L_40));
	}

IL_00e0:
	{
		uint32_t L_41 = V_1;
		int32_t L_42 = ___1_numBytes;
...
IL_00e9:
	{
		...
		uint8_t* L_44 = V_0;
		uint32_t L_45;
		L_45 = math_read32_little_endian_m685EF3EB1C4DB187A503707B71860BC8239DB65C_inline((void*)L_44, NULL);
		V_1 = ((int32_t)il2cpp_codegen_add((int32_t)L_43, ((int32_t)il2cpp_codegen_multiply((int32_t)L_45, ((int32_t)-1028477379)))));
		uint32_t L_46 = V_1;
		uint32_t L_47;
		...
		uint8_t* L_48 = V_0;
		V_0 = ((uint8_t*)il2cpp_codegen_add((intptr_t)L_48, 4));
		int32_t L_49 = V_8;
...
IL_0113:
	{
		int32_t L_50 = V_8;
		int32_t L_51 = ___1_numBytes;
		V_9 = (bool)((((int32_t)L_50) < ((int32_t)((int32_t)(((int32_t)(L_51>>2))&3))))? 1 : 0);
		bool L_52 = V_9;
		if (L_52)
		{
			goto IL_00e9;
...
IL_014d:
	{
		...
		V_11 = (bool)((((int32_t)L_60) < ((int32_t)((int32_t)(L_61&3))))? 1 : 0);
		bool L_62 = V_11;
		if (L_62)
		{
			goto IL_0127;
